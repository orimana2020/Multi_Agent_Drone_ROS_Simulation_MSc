...
class Analysis(object):
    ...
    def save(self, i,k, thresh):
        ...
        general_data['k_init'] = k
        general_data['threshold_factor'] = thresh
        ...
        np.save(params.file_name+'_data_k_'+str(k)+'_thresh_'+str(thresh)+'_'+str(i), np.array(data))
